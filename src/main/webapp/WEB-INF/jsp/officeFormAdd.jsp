				...
				for (var i = 0; i < length; i++) {
					...
					if (office.parentid == 1) {
						...
						for (var j = 0; j < length; j++) {
							var officechild = offices[j];
							if (officechild.parentid == parentid) {
								result += '<button type="button" class="btn btn-light button-style-for-light"\n' +
										'                                            onclick="opentable(\'' + office.href + '\')">\n' +
										'                                        ' + office.name + '\n' +
										'                                    </button>\n' +
										'                                    <br>'
								;
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="/office/form">机构添加</a></li>
	</ul><br/>
